...
QT_MOC_LITERAL(3, 22, 7), // "restaun"
QT_MOC_LITERAL(4, 30, 12), // "tractaReturn"
QT_MOC_LITERAL(5, 43, 13), // "setBackground"
QT_MOC_LITERAL(6, 57, 7) // "contain"

    },
    "MyLineEdit\0enviaText\0\0restaun\0"
    "tractaReturn\0setBackground\0contain"
};
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->restaun(); break;
        case 2: _t->tractaReturn(); break;
        case 3: _t->setBackground((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLineEdit::restaun)) {
                *result = 1;
                return;
            }
        }
